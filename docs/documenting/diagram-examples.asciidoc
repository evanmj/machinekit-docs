...
Diagrams can be created by embedded markup and will be rendered to images in the website automatically. See the link:https://github.com/asciidoctor/asciidoctor-diagram[Asciidoctor Diagram manual] for details.

To see how the examples on this page were created, just click the _Edit this page link.
